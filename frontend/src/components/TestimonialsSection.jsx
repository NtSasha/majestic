    ...
    <section className="pt-8 pb-24 overflow-hidden w-full bg-white relative">
      <div className="max-w-4xl mx-auto px-4 text-center mb-24">
        <h2 className="text-2xl md:text-3xl font-bold mb-4 tracking-tight">
          <span className="text-[#4d3b0e]">900+</span> <span className="text-black">Share Experiences</span>
        </h2>
          ...
          {[...testimonials, ...testimonials, ...testimonials].map((testimonial, index) => (
            <div 
              ...
              className={`
                ...
                ${clickedCardId === testimonial.id ? 'scale-105 shadow-xl border-[#4d3b0e] z-10 relative' : 'shadow-sm hover:shadow-md'}
              `}
            >
