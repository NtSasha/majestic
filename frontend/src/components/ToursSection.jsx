        ...
        {tours.map((tour) => (
          <div key={tour.id} className="relative h-[380px] rounded-2xl overflow-hidden group cursor-pointer shadow-md bg-black">
            ...
            <div className="absolute top-4 left-4">
              <span className="bg-[#4d3b0e] text-white text-xs font-bold px-4 py-1.5 rounded-full">
                Featured
              </span>
            </div>
            ...
            <div className="absolute bottom-4 left-4 right-4 flex justify-between items-end">
              ...
              <div className="flex items-center justify-center w-8 h-8 rounded-full bg-white text-black shrink-0 shadow-sm transition-all hover:bg-majestic-gold hover:text-white group-hover:scale-110">
